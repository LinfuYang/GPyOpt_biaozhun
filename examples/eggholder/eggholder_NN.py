...
seed(123)
func = GPyOpt.objective_examples.experiments2d.eggholder()
...
space = GPyOpt.Design_space(space=[{'name': 'var_1', 'type': 'continuous', 'domain': (-512, 512)},
                                   {'name': 'var_2', 'type': 'continuous', 'domain': (-512, 512)}])
...
for k in range(5, 6):
    ...
    name = 'eggholder_NN_%s_' % k + str(mun_point)
