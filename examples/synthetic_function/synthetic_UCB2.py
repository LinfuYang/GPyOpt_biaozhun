...
for k in range(10, 11):
    ...
    acquisition_optimizer = GPyOpt.optimization.AcquisitionOptimizer(space, optimizer='GMM_UCB2', cluster_k=k, point_num=mun_point)
    ...
    bo = GPyOpt.methods.ModularBayesianOptimization(model, space, objective, acquisition, evaluator, initial_design, normalize_Y=True)

    max_iter = 200
    name = 'synthetic_UCB2_%s_' % k + str(mun_point)
